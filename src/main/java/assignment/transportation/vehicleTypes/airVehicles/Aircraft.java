/**
 * This class is a specialized subclass of the generalized {@link AirVehicle} class that represents an {@link Aircraft}.
 * @author J. Vidal
 * 10.02.2024
 */
...
public class Aircraft extends AirVehicle {
    ...
    /**
     * This is a no args constructor that instantiates an {@link Aircraft} object.
     */
    public Aircraft() {
        super();
    }
    ...
    /**
     * This instantiates an {@link Aircraft} object.
     ...
     */
    public Aircraft(String name, String type, BigDecimal weightCap, BigDecimal vol, BigDecimal cost, BigDecimal speed, int memCount, int mealCost, int crewSalary, String measurements, String description, String interestingFact, String notes) {
