/**
 * This class is a specialized subclass of the generalized {@link AirVehicle} class that represents an {@link Drone}.
 * @author J. Vidal
 * 10.02.2024
 */
...
public class Drone extends AirVehicle {
    ...
    /**
     * This instantiates an empty {@link Drone} object with default null values.
     */
    public Drone() {
        super();
    }
    ...
    /**
     * This instantiates an {@link Drone} object.
     ...
     */
    public Drone(String name, String type, BigDecimal weightCap, BigDecimal vol, BigDecimal cost, BigDecimal speed, int memCount, int mealCost, int crewSalary, String measurements, String description, String interestingFact, String notes) {
