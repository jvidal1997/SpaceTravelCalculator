/**
 * This class is a specialized subclass of the generalized {@link AirVehicle} class that represents an {@link Starship}.
 * @author J. Vidal
 * 10.02.2024
 */
 ...
 * This class is a specialized subclass of the generalized {@link AirVehicle} class that represents an {@link Starship}.
 */
public class Starship extends AirVehicle {

    /**
     * This instantiates an empty {@link Starship} object with default null values.
     */
    public Starship() {
        super();
    }
    ...
    /**
     * This instantiates an {@link Starship} object.
     ...
     */
    public Starship(String name, String type, BigDecimal weightCap, BigDecimal vol, BigDecimal cost, BigDecimal speed, int memCount, int mealCost, int crewSalary, String measurements, String description, String interestingFact, String notes) {
