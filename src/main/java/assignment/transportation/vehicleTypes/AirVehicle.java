/**
 * This class is a generalized subclass of the abstract {@link TransportationVehicle} class that represents an {@link AirVehicle}.
 * @author J. Vidal
 * 10.02.2024
 */
...
public class AirVehicle extends TransportationVehicle {
    ...
    /**
     * This instantiates a default {@link AirVehicle} object.
     */
    public AirVehicle() {
        super();
        setClassification("air");
        this.setNumOfMealsPerDay(3.5);
        this.setPayHoursPerDay(24);
        this.setDragCoefficient(0.0102);
    }

    /**
     * This instantiates an {@link AirVehicle} object.
     ...
     */
    public AirVehicle(String vehicleName, String classification, BigDecimal maxWeight, BigDecimal volume, BigDecimal buildCost, BigDecimal maxSpeed, int numOfMembers, int mealPerMemberCost, int crewSalaryPerHr, String measurements, String description, String interestingFact, String notes) {
