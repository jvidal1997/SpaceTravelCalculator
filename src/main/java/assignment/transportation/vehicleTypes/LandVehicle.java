/**
 * This class is a generalized subclass of the abstract {@link TransportationVehicle} class that represents an {@link LandVehicle}.
 * @author J. Vidal
 * 10.02.2024
 */
...
public class LandVehicle extends TransportationVehicle {
    /**
     * This instantiates a default {@link LandVehicle} object with default null values.
     */
    public LandVehicle() {
        super();
        setClassification("land");
        this.setNumOfMealsPerDay(5);
        this.setPayHoursPerDay(12);
        this.setDragCoefficient(0.0333);
    }

    /**
     * This instantiates an {@link LandVehicle} object.
     ...
     */
    public LandVehicle(String vehicleName, String classification, BigDecimal maxWeight, BigDecimal volume, BigDecimal buildCost, BigDecimal maxSpeed, int numOfMembers, int mealPerMemberCost, int crewSalaryPerHr, String measurements, String description, String interestingFact, String notes) {
