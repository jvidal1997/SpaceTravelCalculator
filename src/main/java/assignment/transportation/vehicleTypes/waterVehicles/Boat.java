/**
 * This class is a specialized subclass of the generalized {@link WaterVehicle} class that represents an {@link Boat}.
 * @author J. Vidal
 * 10.02.2024
 */
...
public class Boat extends WaterVehicle {
    ...
    /**
     * This instantiates an empty {@link Boat} object with default null values.
     */
    public Boat() {
        super();
    }
    ...
    /**
     * This instantiates an {@link Boat} object.
     ...
     */
    public Boat(String name, String type, BigDecimal weightCap, BigDecimal vol, BigDecimal cost, BigDecimal speed, int memCount, int mealCost, int crewSalary, String measurements, String description, String interestingFact, String notes) {
