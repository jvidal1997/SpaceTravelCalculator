/**
 * This class is a specialized subclass of the generalized {@link WaterVehicle} class that represents an {@link Submarine}.
 * @author J. Vidal
 * 10.02.2024
 */
...
public class Submarine extends WaterVehicle {
    ...
    /**
     * This instantiates an empty {@link Submarine} object with default null values.
     */
    public Submarine() {
        super();
    }
    ...
    /**
     * This instantiates an {@link Submarine} object.
     ...
     */
    public Submarine(String name, String type, BigDecimal weightCap, BigDecimal vol, BigDecimal cost, BigDecimal speed, int memCount, int mealCost, int crewSalary, String measurements, String description, String interestingFact, String notes) {
