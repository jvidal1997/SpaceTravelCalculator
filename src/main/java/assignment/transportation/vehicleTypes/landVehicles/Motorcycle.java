/**
 * This class is a specialized subclass of the generalized {@link LandVehicle} class that represents an {@link Motorcycle}.
 * @author J. Vidal
 * 10.02.2024
 */
...
public class Motorcycle extends LandVehicle {
    ...
    /**
     * This instantiates an empty {@link Motorcycle} object with default null values.
     */
    public Motorcycle() {
        super();
    }
    ...
    /**
     * This instantiates an {@link Motorcycle} object.
     ...
     */
    public Motorcycle(String name, String type, BigDecimal weightCap, BigDecimal vol, BigDecimal cost, BigDecimal speed, int memCount, int mealCost, int crewSalary, String measurements, String description, String interestingFact, String notes) {
