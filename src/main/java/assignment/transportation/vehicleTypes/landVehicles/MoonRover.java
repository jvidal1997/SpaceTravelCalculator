/**
 * This class is a specialized subclass of the generalized {@link LandVehicle} class that represents an {@link MoonRover}.
 * @author J. Vidal
 * 10.02.2024
 */
 ...
 * This class is a specialized subclass of the generalized {@link LandVehicle} class that represents an {@link MoonRover}.
 */
public class MoonRover extends LandVehicle {

    /**
     * This instantiates an empty {@link MoonRover} object with default null values.
     */
    public MoonRover() {
        super();
    }
    ...
    /**
     * This instantiates an {@link MoonRover} object.
     ...
     */
    public MoonRover(String name, String type, BigDecimal weightCap, BigDecimal vol, BigDecimal cost, BigDecimal speed, int memCount, int mealCost, int crewSalary, String measurements, String description, String interestingFact, String notes) {
