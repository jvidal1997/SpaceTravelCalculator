/**
 * This class is a specialized subclass of the generalized {@link LandVehicle} class that represents an {@link Car}.
 * @author J. Vidal
 * 10.02.2024
 */
...
public class Car extends LandVehicle {
    ...
    /**
     * This instantiates an empty {@link Car} object with default null values.
     */
    public Car() {
        super();
    }
    ...
    /**
     * This instantiates an {@link Car} object.
     ...
     */
    public Car(String name, String type, BigDecimal weightCap, BigDecimal vol, BigDecimal cost, BigDecimal speed, int memCount, int mealCost, int crewSalary, String measurements, String description, String interestingFact, String notes) {
